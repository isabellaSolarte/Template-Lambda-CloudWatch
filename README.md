...
> **Propósito del Repositorio:** Por motivos del acuerdo de confidencialidad establecidad por el banco, este repositorio contiene **un ejemplo de los archivos base y la plantilla de Terraform** utilizados para el aprovisionamiento de la función Lambda. Los manifiestos están diseñados para ser consumidos y parametrizados de forma dinámica por el motor de *Scaffolding* de Backstage.
